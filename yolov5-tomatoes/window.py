...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/icon-tomato.png"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        img_detection_title = QLabel("番茄图片识别功能")
        ...
        up_img_button.setStyleSheet("QPushButton{color:white}"
                                    "QPushButton:hover{background-color: rgb(255, 101, 0);}"
                                    "QPushButton{background-color:rgb(255, 224, 204)}"
        ...
        about_title = QLabel('欢迎使用番茄成熟度检测系统\n')  # todo 修改欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/contact.jpg'))
        about_img.setAlignment(Qt.AlignCenter)

        label_super = QLabel()  # todo 更换作者信息
        label_super.setText("<a>如有问题，欢迎联系作者：杜颖 （1945582535@qq.com）</a>")
        label_super.setFont(QFont('楷体', 20))
        ...
        self.addTab(vid_detection_widget, '动态捕捉检测')

        self.setTabIcon(0, QIcon('images/UI/icon-person.png'))
        self.setTabIcon(1, QIcon('images/UI/icon-photo.png'))
        self.setTabIcon(2, QIcon('images/UI/icon-vedio.png'))
        # self.setTabIcon(2, QIcon('images/UI/helm.png'))
