...
# python train.py --data helmet_data.yaml --cfg helmet_yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 100 --batch-size 4 --device cpu
...
# python val.py --data data/helmet_data.yaml --weights runs/train/exp21/weights/best.pt --img 640
